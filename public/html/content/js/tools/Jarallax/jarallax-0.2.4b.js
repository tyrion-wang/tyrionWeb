...
jQuery.support.android = /android/i.test(navigator.userAgent.toLowerCase());
jQuery.support.blackBerry = /blackberry/i.test(navigator.userAgent.toLowerCase());
jQuery.support.webOs = /webos/i.test(navigator.userAgent.toLowerCase());
jQuery.support.windowsPhone = /windows phone/i.test(navigator.userAgent.toLowerCase());
jQuery.support.iDevice = /ipad|iphone|ipod/i.test(navigator.userAgent.toLowerCase());
jQuery.support.iPad = /ipad/i.test(navigator.userAgent.toLowerCase());
jQuery.support.iPhone = /iphone/i.test(navigator.userAgent.toLowerCase());
jQuery.support.iPod = /ipod/i.test(navigator.userAgent.toLowerCase());
jQuery.support.mobile = jQuery.support.android ||
    jQuery.support.blackBerry ||
    jQuery.support.webOs ||
    jQuery.support.windowsPhone ||
    jQuery.support.iDevice;
jQuery.support.nonMobile = !jQuery.support.mobile;
